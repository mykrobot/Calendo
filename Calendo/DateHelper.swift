...
extension NSDate {
    ...
    func formatDate() -> [Int] {
        ...
        let components: NSDateComponents = NSCalendar.currentCalendar().components([.Day], fromDate: self)
        let today: Int = components.day
        let yesterday: Int = components.day - 1
        let ereyesterday: Int = components.day - 2
